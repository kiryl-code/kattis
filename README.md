# [Bard](https://open.kattis.com/problems/bard)
...
The first line of input contains an integer N, 2 <= N <= 100, the number of villagers. The villagers are numbered 1
to N. Villager number 1 is the bard.
